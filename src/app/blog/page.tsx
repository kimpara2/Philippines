...
export const metadata: Metadata = {
  title: "ニュース・コラム | フィリピンパブNavi",
  description: "フィリピンパブNaviの最新ニュース・コラム・イベント情報をお届けします。全国のフィリピンパブ情報を発信中！",
  alternates: {
...
export default async function BlogPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-10">
      ...
      <p className="text-gray-400 text-sm mb-8">フィリピンパブNaviからの最新情報をお届けします</p>
