...
const CATEGORY_FAQS: Record<string, Array<{ q: string; a: string }>> = {
  フィリピンパブ: [
    { q: "フィリピンパブとはどんなお店ですか？", a: "フィリピンパブはフィリピン人女性スタッフが接客するスタイルのバーです。カラオケや会話を楽しみながらお酒を飲むお店で、スタッフはタガログ語・英語・日本語を話せる方が多く、異文化交流も楽しめます。" },
    { q: "フィリピンパブの料金相場はいくらですか？", a: "一般的にシステム料（席料）1,000〜3,000円＋ドリンク代が基本です。スタッフへの同伴ドリンクをオーダーすると1時間あたり3,000〜8,000円程度が目安です。お店によって異なるため、各店舗ページの料金情報をご確認ください。" },
    { q: "フィリピンパブは初めてでも一人で入れますか？", a: "はい、ほとんどのフィリピンパブは初めての方・一人でのご来店を大歓迎しています。事前にお店へ「初めてですが」と一言添えると、スタッフが丁寧に案内してくれます。" },
    { q: "フィリピンパブのスタッフとはどんな話をするのですか？", a: "出身地・家族のこと・フィリピンの文化・旅行の話など、様々な会話が楽しめます。一緒にカラオケを楽しんだり、お酒を飲みながら気軽におしゃべりするのがフィリピンパブの醍醐味です。" },
    { q: "フィリピンパブは何時から何時まで営業していますか？", a: "一般的に夜20時〜翌朝5時頃まで営業しているお店が多いです。各店舗のページに営業時間を掲載していますので、事前にご確認ください。" },
  ],
  スナック: [
    { q: "スナックとはどんなお店ですか？", a: "スナックはカウンター越しにママやスタッフと会話・カラオケを楽しむ日本の大衆バーです。アットホームな雰囲気で常連客が多く、初めての方でも気軽に入れるお店がほとんどです。" },
    { q: "スナックの料金相場はいくらですか？", a: "スナックはセット料金制が多く、1時間1,000〜3,000円程度が相場です。ボトルキープやカラオケ代が別途かかる場合もあります。フィリピンパブと比べてリーズナブルなお店が多いのが特徴です。" },
    { q: "スナックは一人でも入れますか？", a: "はい、スナックは一人での来店が基本のスタイルです。カウンター席でママやスタッフと話しながらお酒を楽しむのがスナックの醍醐味で、常連さんと仲良くなれることも多いです。" },
    { q: "スナックにカラオケはありますか？", a: "多くのスナックにカラオケ設備があります。スタッフや他のお客さんと一緒に歌を楽しめます。カラオケ設備の有無は店舗によって異なりますので、事前に確認されることをおすすめします。" },
    { q: "スナックの営業時間は？", a: "スナックは一般的に夜19時〜翌朝3時頃まで営業しているお店が多いです。日によって異なる場合もあるため、各店舗ページや直接お電話でご確認ください。" },
  ],
  ガールズバー: [
    { q: "ガールズバーとはどんなお店ですか？", a: "ガールズバーは女性スタッフがカウンター越しに接客するスタイルのバーです。キャバクラと異なりスタッフは席に同席せずカウンター越しの接客で、リーズナブルに楽しめるのが特徴です。" },
    { q: "ガールズバーの料金相場はいくらですか？", a: "ガールズバーはドリンク1杯500〜1,500円程度が多く、キャバクラやフィリピンパブと比べてリーズナブルです。チャージや入場料がかかるお店もあります。" },
    { q: "ガールズバーはどんな雰囲気ですか？", a: "おしゃれな内装のお店が多く、カジュアルに飲める雰囲気です。スタッフとカウンター越しに気軽に会話を楽しめます。20〜30代の若いスタッフが多く、活気のある雰囲気です。" },
    { q: "ガールズバーとキャバクラの違いは何ですか？", a: "ガールズバーはスタッフがカウンター越しに接客し、席に同席しません。キャバクラはスタッフが席に同席して接客するスタイルです。ガールズバーの方が料金がリーズナブルなことが多いです。" },
  ],
  バー: [
    { q: "バーとはどんなお店ですか？", a: "バーはお酒を中心に提供するお店です。カウンター席でバーテンダーとの会話を楽しんだり、カクテルや本格的なウイスキーを味わったりできます。一人でも入りやすいお店が多いのが特徴です。" },
    { q: "バーの料金相場はいくらですか？", a: "バーはドリンク1杯700〜2,000円程度が相場です。チャージ料（席料）がかかるお店もあります。カクテルや高級ウイスキーなど、提供するお酒によって価格帯は異なります。" },
    { q: "バーは初めてでも一人で入れますか？", a: "はい、バーは一人でのご来店を歓迎しているお店がほとんどです。バーテンダーに好みのお酒を伝えれば、おすすめのカクテルやウイスキーを提案してもらえます。" },
  ],
  キャバクラ: [
    { q: "キャバクラとはどんなお店ですか？", a: "キャバクラは女性キャストが席に同席して接客するスタイルのお店です。会話やカラオケを楽しみながら高級感のある雰囲気でお酒を飲むことができます。" },
    { q: "キャバクラの料金相場はいくらですか？", a: "キャバクラはシステム料（席料）3,000〜5,000円程度にキャストのドリンク代や指名料が加わります。1時間あたり10,000〜30,000円程度が目安ですが、お店によって大きく異なります。" },
    { q: "キャバクラで指名はできますか？", a: "はい、ほとんどのキャバクラで在籍キャストを指名することができます。初回は指名なしで気に入ったキャストを本指名にすることもできます。指名料はお店によって異なります。" },
    { q: "キャバクラとガールズバーの違いは何ですか？", a: "キャバクラはスタッフが席に同席して接客するスタイルで、ガールズバーはカウンター越しの接客です。キャバクラの方が高級感があり料金も高めですが、より密な接客サービスを受けられます。" },
  ],
};
...
export default async function AreaPage({ params, searchParams }: Props) {
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-10">
      ...
      {/* FAQ セクション（カテゴリ選択時はカテゴリ別、未選択はエリア別） */}
      {(category ? CATEGORY_FAQS[category] : AREA_FAQS[decodedArea]) && (
        <div className="mt-12">
          <h2 className="text-lg font-bold text-white mb-4">
            {category ? `${category}` : decodedArea}についてよくある質問
          </h2>
          <div className="space-y-3">
            {(category ? CATEGORY_FAQS[category] : AREA_FAQS[decodedArea]).map((faq, i) => (
