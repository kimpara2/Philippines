...
export const metadata: Metadata = {
  title: "よくある質問（FAQ）| フィリピンパブNavi",
  description:
    "フィリピンパブとは何か、料金・システム・初めての方の疑問をまとめました。フィリピンパブNavi のよくある質問ページです。",
...
const FAQS = [
  ...
  {
    q: "お店はどうやって選べばいいですか？",
    a: "フィリピンパブNaviでは、エリア・口コミ評価・在籍キャスト情報で絞り込んで選ぶことができます。口コミや評価を参考にしながら、自分の好みに合ったお店を探してみてください。",
  },
  {
